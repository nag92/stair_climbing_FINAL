...
% GMM is similar to K-means in that it assigns points to clusters. GMM improvement assigns a probability to the point belonging to a cluster. 
...
% The number of bins $K$ has to be set for the model. The model output is very sensitive to the number of bins set. If there are too many, the model will overfit to the data set; while if there are too few, the model will be poorly fit.
